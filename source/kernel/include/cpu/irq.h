...
#define IRQ1_KEYBOARD		0x21				// keyboard interupt
#define IRQ14_HARDDISK_PRIMARY		0x2E		// ATA disk interupt in bus
...
/**
 *  Stack structure corresponding to interrupt occurrence, temporarily for situations with no privilege level
 */
...
#define PIC_ICW1_ICW4		(1 << 0)		// 1 - need init ICW4
#define PIC_ICW1_ALWAYS_1	(1 << 4)		
#define PIC_ICW4_8086	    (1 << 0)        // 8086 mode

#define PIC_OCW2_EOI		(1 << 5)		// 1 - EOI command

#define IRQ_PIC_START		0x20			// PIC interupt number
